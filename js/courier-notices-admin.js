(function () {
	...
	var __webpack_modules__ = {
			366: function (
						...
						if (
							...
							($.extend(Timepicker.prototype, {
								...
								_newInst: function ($input, opts) {
									...
									for (var attrName in this._defaults)
										if (
											this._defaults.hasOwnProperty(
												attrName
											)
										) {
											var attrValue = $input.attr(
												'time:' + attrName
											);
											if (attrValue)
												try {
									...
									((tp_inst._defaults = $.extend(
										...
										'string' ==
										typeof tp_inst._defaults.controlType
											? ('slider' ===
													tp_inst._defaults
														.controlType &&
													void 0 === $.ui.slider &&
									...
									var timezoneList = [
										...
										-420, -360, -300, -270, -240, -210,
										-180, -120, -60, 0, 60, 120, 180, 210,
										240, 270, 300, 330, 345, 360, 390, 420,
										480, 525, 540, 570, 600, 630, 660, 690,
										720, 765, 780, 840,
									];
									...
									return (
										...
										void 0 !== tp_inst._defaults.minDate &&
											tp_inst._defaults.minDate instanceof
												Date &&
										...
										void 0 !== tp_inst._defaults.maxDate &&
											tp_inst._defaults.maxDate instanceof
												Date &&
								...
								_addTimePicker: function (e) {
									var t = $.trim(
										this.$altInput &&
											this._defaults.altFieldTimeOnly
											? this.$input.val() +
													' ' +
													this.$altInput.val()
											: this.$input.val()
								...
								_afterInject: function () {
									...
									$.isFunction(e.afterInject) &&
										e.afterInject.call(this);
								},
								...
								($.datepicker._base_doKeyPress =
									$.datepicker._doKeyPress),
								($.datepicker._doKeyPress = function (e) {
									var t = $.datepicker._getInst(e.target),
										i = $.datepicker._get(t, 'timepicker');
									if (
										i &&
										$.datepicker._get(t, 'constrainInput')
									) {
								...
								($.datepicker._disableTimepickerDatepicker =
									function (e) {
										...
										if (t) {
											...
											($(e).datepicker('getDate'),
												i &&
													((t.settings.showTimepicker =
														!1),
													(i._defaults.showTimepicker =
														!1),
													i._updateDateTime(t)));
										}
									}),
								...
								($.datepicker._setTimeDatepicker = function (
									e,
									t,
									i
								) {
								...
								($.datepicker._setDateDatepicker = function (
									e,
									t
								) {
									...
									if (i) {
										...
										(s instanceof Date
											...
											this._setTimeDatepicker(e, n, !0));
									}
								}),
								($.datepicker._base_getDateDatepicker =
									$.datepicker._getDateDatepicker),
								($.datepicker._getDateDatepicker = function (
									e,
									t
								) {
									var i = this._getInst(e);
									if (i) {
										...
										return this._base_getDateDatepicker(
											e,
											t
										);
									}
								}),
								($.datepicker._base_parseDate =
								...
								($.datepicker._base_formatDate =
									$.datepicker._formatDate),
								($.datepicker._formatDate = function (
									e,
									t,
									i,
									s
								...
								($.datepicker._optionDatepicker = function (
									e,
									t,
									i
								) {
											...
											(u
												? ((u =
														0 === u
															? new Date()
															: new Date(u)),
													(a._defaults.minDate = u),
													(a._defaults.minDateTime =
														u))
												: d
													? ((d =
															0 === d
														...
														(a._defaults.maxDate =
															d),
														(a._defaults.maxDateTime =
															d))
													: m &&
														(a._defaults.onSelect =
															m),
											u || d)
										)
											return (
												(c = (l = $(e)).datetimepicker(
													'getDate'
												)),
												(o =
							...
							var isEmptyObject = function (e) {
								...
								computeEffectiveSetting = function (e, t) {
									return e && e[t]
										? e[t]
										: $.timepicker._defaults[t];
								},
								splitDateTime = function (e, t) {
									var i = computeEffectiveSetting(
											t,
											'separator'
										),
										s = computeEffectiveSetting(
											t,
											'timeFormat'
										).split(i).length,
										n = e.split(i),
								...
								parseDateTimeInternal = function (
									e,
									t,
									i,
									s,
									...
									return { date: a, timeObj: o };
								},
								selectLocalTimezone = function (e, t) {
									if (e && e.timezone_select) {
										var i = t || new Date();
										e.timezone_select.val(
											-i.getTimezoneOffset()
										);
									}
								};
							(($.timepicker = new Timepicker()),
								($.timepicker.timezoneOffsetString = function (
									e,
									t
								) {
								...
								($.timepicker.timezoneOffsetNumber = function (
									e
								) {
								...
								($.timepicker.timezoneAdjust = function (
									e,
									t,
									i
								) {
								...
								($.timepicker.datetimeRange = function (
									e,
									t,
									i
								) {
								...
								($.timepicker._util = {
									...
									_computeEffectiveSetting:
										computeEffectiveSetting,
									_splitDateTime: splitDateTime,
									_parseDateTimeInternal:
				...
				$.fn.equalize = function () {
					let e = $('[data-equalizer-watch]', this),
						t = 0;
					return (
						e
							.each(function () {
	...
	function __webpack_require__(e) {
		...
		return (
			__webpack_modules__[e](i, i.exports, __webpack_require__),
			i.exports
		);
	}
	...
	!(function () {
		...
		jQuery(function () {
			...
			((0, e.A)(),
				(function (e) {
					let t = e.fn.serializeArray;
					e.fn.serializeArray = function () {
						let i = t.apply(this),
							s = {};
						e.each(this.find('input'), function (e, t) {
				...
				(function () {
					let e = a('.courier-notices-settings-form');
					(e.find('#submit').on('click', function (e) {
						(e.preventDefault(),
							a(this)
								.attr({ disabled: 'disabled', value: 'Saving' })
								.parents('form')
								.submit());
					}),
						e.on('submit', function (t) {
							(t.preventDefault(),
								...
								a(this));
							let i = a(this).serializeArray();
							((i.settings_key = i.option_page),
								(i.method = 'POST'),
								(i._wpnonce =
									courier_notices_admin_data.settings_nonce),
								a
									.ajax({
				...
				(function () {
					...
					function i(e) {
						(n(),
							(function (e) {
								let t =
										s('#courier_style').find(
											'option:selected'
										),
									i = t.val(),
									n = t.text(),
									a = s('#show-hide-info'),
									r = s('#selected-courier-notice-type'),
									o = r.attr('data-enable-title');
								(r.text(n),
									s('.show-hide-toggle')
										.removeClass('hide')
										.hide(),
									-1 === o.indexOf(i)
										? (a.hide(),
											s('#show-title-toggle').show())
										: (a.show(),
											s('#hide-title-toggle').show()));
							})());
					}
					function n(e) {
						('popup-modal' ===
						s('#courier_style').find('option:selected').val()
							? (s('#courier_placement').val('popup-modal'),
								s('#courier-notice_placement_container').hide())
							: s('#courier-notice_placement_container').show(),
							'popup-modal' ===
							s('#courier_style').find('option:selected').val()
								? s('#courier_dismissible')
					...
					function a(e) {
						'informational' !==
						s('#courier_style').find('option:selected').val()
							? s('#courier-notice_type_container').hide()
							: s('#courier-notice_type_container').show();
					}
					function r(e) {
						let t = s('#courier_placement_display');
						s('#courier_placement').val(t.val());
					}
					function o() {
						var e = s('<option />')
							.val('courier_expired')
						...
						('courier_expired' ===
							courier_notices_admin_data.post_status &&
							(s('#post-status-display').text(
								courier_notices_admin_data.strings.expired
							),
							e.attr('selected', 'selected')),
							s('#post_status').append(e));
					}
					function c(e) {
						(e.preventDefault(), e.stopPropagation());
						let t = s(this),
							i = t.attr('data-courier-notice-id'),
							n = t.parents('.notice');
						s.post(
							courier_notices_admin_data.reactivate_endpoint +
								i +
								'/',
							{
								success: function (e) {
					...
					function l(e) {
						e.preventDefault();
						let t = s(this).data('copy'),
							i = s('#' + t),
							n = s('.copy-link-indicator'),
						...
						if (
							...
							try {
								...
								(o && (r = !0),
									o ||
										(r = prompt(
											courier_notices_admin_data.strings
												.copy,
											i.text()
										)));
							} catch (e) {
						...
						r &&
							(n
								.text(courier_notices_admin_data.strings.copied)
								.fadeIn(),
							setTimeout(function () {
								n.fadeOut(function () {
									n.text('');
					...
					(s('#courier_expire_date').datetimepicker({
						minDate: 0,
						controlType: 'select',
						timeFormat: 'hh:mm tt',
						dateFormat: 'MM dd, yy',
						...
						afterInject: function () {
							(s('button.ui-datepicker-current').addClass(
								'button button-secondary'
							),
								s('button.ui-datepicker-close').addClass(
									'right button button-primary'
								));
						},
					}),
						'courier_notice' ===
							courier_notices_admin_data.post_type &&
							e.on('ready', o),
						a(),
						n(),
						t
							.on('click', '.courier-reactivate-notice', c)
							.on('click', '.copy-text', l)
							.on('change', '#courier_style', a)
							.on('change', '#courier_placement_display', r)
							.on('change', '#courier_style', i)
							.on('focus', '#courier-shortcode', function () {
								s('#courier-shortcode').select();
							}));
				})(),
				(o = n(document)),
				(c = n('body')),
				'courier_notice' === courier_notices_admin_data.post_type &&
					o.on('ready', function () {
						var e = n('<option />')
							.val('courier_expired')
							.text(courier_notices_admin_data.strings.label);
						('courier_expired' ===
							courier_notices_admin_data.post_status &&
							(n('#post-status-display').text(
								courier_notices_admin_data.strings.expired
							),
							e.attr('selected', 'selected')),
							n('#post_status').append(e));
					}),
				c
					.on('click', '.editinline', function () {
						var e = n(this)
								.parents('tr.iedit')
								.attr('id')
								.replace('post-', ''),
							t = n('#inline_' + e + ' ._status').text(),
							i = '',
							s = n('<option />')
								.text(courier_notices_admin_data.strings.label)
								.attr('value', 'courier_expired');
						setTimeout(function () {
							(n('#edit-' + e),
								(i = n(
									'#edit-' + e + ' select[name="_status"]'
								)).append(s),
								i.val(t));
						}, 300);
					})
					.on('click', '.courier-reactivate-notice', function (e) {
						(e.preventDefault(), e.stopPropagation());
						var t = n(this),
							i = t.attr('data-courier-notice-id'),
							s = t.parents('.notice');
					...
					.on(
						'click',
						'.courier-reactivate-notice-link',
						function (e) {
							(e.preventDefault(), e.stopPropagation());
							var t = n(this),
								i = t.attr('data-courier-notice-id'),
									...
									.done(function (e) {
										if (e.success) {
											...
											(i.setDate(i.getDate() + 30),
												...
												s.addClass('updated'),
												setTimeout(function () {
													s.removeClass('updated');
												}, 2e3));
										} else
											(a.text('Error').addClass('error'),
												setTimeout(function () {
													a.text(
														'Reactivate'
													).removeClass(
				...
				(function () {
					(t(window), t(document), t('body'));
					let e = t('#courier-notices-welcome-panel');
					e.find('.courier-notices-welcome-panel-close').on(
						'click',
						function (i) {
							(i.preventDefault(),
								e.addClass('hidden'),
								t.post(ajaxurl, {
									...
									visible: 0,
									courier_notices_welcome_panel: t(
										'#courier_notices_welcome_panel'
									).val(),
								}));
						}
					);
				...
				(function () {
					let e = i('body'),
						t =
							(i('.courier_notice_page_courier'),
							i('#courier-notice-type-new'),
							i('.courier-type-color')),
						s = i('#courier-notice-type-template')
							.text()
							.split(/\{(.+?)\}/g),
						n =
							(i('#courier-notice-type-edit-template')
								.text()
								.split(/\{(.+?)\}/g),
							{
								indicator: i('#courier-notice-loader').html(),
								cancel: courier_notices_admin_data.strings
									.cancel,
								...
								tooltip:
									courier_notices_admin_data.strings.editurl,
								width: '100%',
							});
					function a(e) {
						((t = e
							? e.find('.courier-type-color')
							: i('.courier-type-color')),
							t.length &&
								t.wpColorPicker({
									change: function (e, t) {
					...
					e.on('click', '.courier-notices-type-delete', function (e) {
						e.preventDefault();
						var t,
							s = i(this),
							n = i('<button />', {
						...
						!0 !== s.data('confirm')
							? (n.append(a),
								s
									.addClass(
										'button button-secondary button-editing'
									)
									.attr(
										'aria-label',
										courier_notices_admin_data.strings
						...
						.on('click', '#add-courier-notice-type', function (e) {
							(e.preventDefault(),
								i(this)
									.addClass('disabled')
								...
								(function (e) {
									...
									((t = i(t)),
										i(
											'table.courier_notice_page_courier tbody'
										).append(t),
										a(t));
								})(i.extend(!0, {}, n)));
						})
							...
							function (e) {
								(e.preventDefault(),
									i(this)
										.addClass('disabled')
										.attr('disabled', 'disabled'));
								var t = i('#courier-notice-type-new');
								i.post(ajaxurl, {
									action: 'courier_notices_add_type',
									page: 'courier',
									courier_notices_add_type:
										courier_notices_admin_data.add_nonce,
									courier_notice_type_new_title: i(
										'#courier-notice-type-new-title'
									).val(),
									courier_notice_type_new_css_class: i(
										'#courier-notice-type-new-css-class'
									).val(),
									courier_notice_type_new_color: i(
										'#courier-notice-type-new-color'
									).val(),
									courier_notice_type_new_text_color: i(
										'#courier-notice-type-new-text-color'
									).val(),
									courier_notice_type_new_icon_color: i(
										'#courier-notice-type-new-icon-color'
									).val(),
									courier_notice_type_new_bg_color: i(
									...
									(e = JSON.parse(e)) &&
										...
										t
											...
											.promise()
											.done(function () {
												i('#add-courier-notice-type')
													.removeAttr('disabled')
													.removeClass('disabled');
												for (const t in e.fragments)
													i(t).html(e.fragments[t]);
											});
								});
							}
						)
						...
						.on(
							...
							function (e) {
								(e.preventDefault(),
									i('#courier-notice-type-edit').replaceWith(
										''
									));
								var t = i(this).closest('tr');
								(i('.courier-icon', t).removeAttr('style'),
									i('.courier-content-wrapper', t).removeAttr(
										'style'
									),
									i('.notice-options', t).hide(),
									i('.courier-notice-type-title', t).show(),
									i('.courier-notice-editing').removeClass(
										'courier-notice-editing'
									),
									t
										.find('.courier-type-color')
										.each(function () {
											i(this).val(
												i(this).data('default-color')
											);
										}),
									t
										.find('.courier-type-color')
								...
								(t
									...
									i
										.post(ajaxurl, {
											...
											courier_notice_type_edit_title: s
												.find(
													'.courier-notice-type-edit-title'
												)
												.val(),
											courier_notice_type_edit_css_class:
												s
													.find(
														'.courier-notice-type-edit-css-class'
													)
													.val(),
											courier_notice_type_edit_color: s
												.find(
													'.courier-notice-type-edit-color'
												)
												.val(),
											courier_notice_type_edit_text_color:
												s
													.find(
														'.courier-notice-type-edit-text-color'
													)
													.val(),
											courier_notice_type_edit_icon_color:
												s
													.find(
														'.courier-notice-type-edit-icon-color'
													)
													.val(),
											courier_notice_type_edit_bg_color: s
												.find(
													'.courier-notice-type-edit-bg-color'
												)
												.val(),
						...
						.on('click', '.courier-notice-type-edit', function (e) {
							e.preventDefault();
							var t = i(this).closest('tr');
							(i(
								...
								t
									...
									.find('.notice-options')
									.show(),
								t.find('.courier-notice-type-title').hide(),
								a(t));
						})
						.on(
							'click',
							...
							function (e) {
								(e.stopPropagation(),
									i('table.courier_notice_page_courier')
										.find('input,button')
										.attr('disabled', 'disabled'),
									i('#nds-post-body')
										.find('input[type="hidden"]')
										.attr('disabled', 'disabled'),
									i('.settings-form').submit());
							}
						);
				})(),
				(function () {
					function e(e) {
						e.preventDefault();
						var t = r(this).parents('.courier-admin-notice');
						r.post(
							ajaxurl,
							{
								action: 'courier_dismiss_notification',
								courier_notification_type: t.attr('data-type'),
								_ajax_nonce:
									courier_notices_admin_data.dismiss_nonce,
							},
							function (e) {
					...
					r('body')
						.on('click', '.courier-admin-notice .notice-dismiss', e)
						.on(
							'click',
