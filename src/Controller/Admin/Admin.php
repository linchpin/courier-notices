...
class Admin {
	...
	public function admin_enqueue_scripts( $hook ) {
		...
		$courier_notices_admin_data = array(
			...
			'post_status'         => $status,
			'reactivate_endpoint' => get_rest_url( get_current_blog_id(), '/courier-notices/v1/reactivate/' ),
			'settings_endpoint'   => get_rest_url( get_current_blog_id(), '/courier-notices/v1/settings/' ),
			'dateFormat'          => get_option( 'date_format' ),
			'settings_nonce'      => wp_create_nonce( 'wp_rest' ),
