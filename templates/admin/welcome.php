...
<div id="courier-notices-welcome-panel" class="<?php echo esc_attr( $classes ); ?>">
	...
	<a class="courier-notices-welcome-panel-close" href="<?php echo esc_url( admin_url( 'edit.php?post_type=courier_notice&courier_welcome=0' ) ); ?>" aria-label="<?php esc_attr_e( 'Dismiss the Courier welcome panel', 'courier-notices' ); ?>"><?php esc_html_e( 'Dismiss', 'courier-notices' ); ?></a>
	<div class="courier courier-welcome-panel-content">
		...
		<div class="courier-intro grid-x">
			...
			<div class="cell auto padding-horizontal">
				<p class="about-description"><?php esc_html_e( 'Courier allows you to notify users about the happening(s) on your site', 'courier-notices' ); ?></p>
		...
		<div class="welcome-panel-column-container grid-x">
			...
			<div class="cell auto small-full padding-horizontal">
				<h3><?php esc_html_e( 'More Actions', 'courier-notices' ); ?></h3>
				<ul>
					...
					<li><?php printf( '<a href="%s" target="_blank"><span class="courier-icon icon-linchpin-logo-fill"></span>' . esc_html__( 'About Linchpin', 'courier-notices' ) . '</a>', esc_url( __( 'https://linchpin.com', 'courier-notices' ) ) ); ?></li>
					<li><?php printf( '<a href="%s" target="_blank"><span class="courier-icon icon-github-logo"></span>' . esc_html__( 'View Features Requests', 'courier-notices' ) . '</a>', esc_url( __( 'https://github.com/linchpin/courier/issues', 'courier-notices' ) ) ); ?></li>
				</ul>
			</div>
