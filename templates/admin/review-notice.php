...
<div class="courier-notice courier-update-notice notice notice-info is-dismissible" data-type="review-notice">
	<div class="table">
		<div class="table-cell">
			<img src="<?php echo esc_attr( COURIER_PLUGIN_URL . 'img/courier-logo-fullcolor.svg' ); ?>" class="courier-logo" alt="<?php esc_attr_e( 'Courier Logo', 'courier' ); ?>">
		</div>
		<div class="table-cell">
			<p class="no-margin">
				<?php
				printf(
					wp_kses_post(
						...
						__( 'Thanks for using Courier for the past %1$s. <strong>This is a huge compliment</strong> and we could really use your help with a <a href="%2$s">review on wordpress.org</a>', 'courier' )
					),
			...
			<p class="no-margin">
				<?php echo wp_kses_post( __( 'If you like Courier and want us to continue development (including block editor and more plugin integrations) we could use the support! <a href="#" class="review-dismiss">No Thanks</a>', 'courier' ) ); ?>
			</p>
		</div>
	</div>
</div>
