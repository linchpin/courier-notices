...
<div id="courier-shortcode-container" class="misc-pub-section">
	<div class="copy-text" data-copy="courier-shortcode">
		...
		<span class="copy-text dashicons dashicons-clipboard courier-help" data-copy="courier-shortcode" title="<?php esc_html_e( 'Copy Courier Shortcode', 'courier-notices' ); ?>"></span>
	</div>
